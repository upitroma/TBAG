...
public class EnemyNameGen
{
  ...
  public static void generateValues()
  {
    ...
    "Carla", "Molly","Chris","Spencer","Greg","Nick","Muffins","Kirito","Asuna","Leluch","Rangnar", "Lilth", "Addison", "Loki","Dalton","Buzz" };
    lName = new String[]{"Kemp","Kratz","Ratty","Baddy","Lad","Rudoplh","Holdings","Naus","Bashem","Bander","lothbrook","Adams","Rounder","Cupcakes","Huggybear","McFluff","Ranger","LightYear","McLovin", "Crystal",
      "Ranglinger","Guts","Rebdak","Swan","Rabid","Lenny","Java","Gauva"};
    ...
    desc = new String[]{"Has a wife and " + kids + " kids", "He finna kill you", "Just your everyday bandito","Played despacito 1 too many times",
    ...
    if(titleYN == 0){name = (name1 + " " + name2);
      discription = (desc1);}
    if(titleYN == 1){name = (name1 + " " + name2 + " " + title1);
      discription = (desc1);}  
     /*
